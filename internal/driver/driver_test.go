...
func TestDriverSuite(t *testing.T) {
	...
	if err := linodeDriver.SetupLinodeDriver(context.Background(), fakeCloudProvider, mounter, deviceUtils, md, driver, vendorVersion, bsPrefix, encrypt, metricsAddress); err != nil {
