...
SKIP_TESTS=(
  ...
  "Controller Service ControllerGetCapabilities should return appropriate capabilities"
  "Controller Service GetCapacity should return capacity (no optional values added)"
